...
const Footer = () => {
  return (
    <footer className="bg-red-600 text-white pt-12">
      <div className="contacts footer bg-red-600 lg:px-[200px] flex flex-col items-center md:flex-row justify-between">
      ...
      <div className="footer pt-10 bg-red-600 flex flex-col md:flex-row text-white">
